...
namespace Online_Store.UI.Controllers
{
    public class Category2Controller : Controller
    {
        ...
        public Category2Controller(ICategory2Service Category2Service, ICategory1Service Category1Service)
        {
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            var Category2 = await _Category2Service.GetByIDAsync(id);
            if (Category2 == null)
            {
                return NotFound();
            }
        ...
        {
            var Category2 = await _Category2Service.GetByIDAsync(id);
            await _Category2Service.DeleteAsync(Category2);
            return RedirectToAction(nameof(Index));
        }
    }
}
